...
# ZSH
alias zshaudit="compaudit | xargs chmod g-w"

# Custom
alias pbd="yarn run build"
alias pck="yarn run check"
alias pft="yarn run format"
alias plt="yarn run lint"
alias ppk="yarn run pack"
alias prl="yarn run release"
alias put="yarn run test"
alias putc="yarn run test --coverage"
alias putu="yarn run test --updateSnapshot"
alias putw="yarn run test --watch"
alias ptc="yarn run type"

# Rust/Cargo
alias cgb="cargo build --workspace"
alias cgbw="cargo wasi build"
alias cgc="cargo check --workspace"
alias cgf="cargo fmt --all"
alias cgl="cargo clippy --workspace --all-targets"
alias cglf="cgl --fix --allow-staged"
alias cgt="cargo test --workspace"
alias cgto="cargo test --workspace -- --nocapture --show-output"
alias cgr="cargo run"
alias cmb="cargo make build"
alias cmc="cargo make clean"
alias cmf="cargo make format"
alias cml="cargo make lint"
alias cmlf="cargo make lint-fix"
alias cmt="cargo make test"
alias cnt="cargo nextest run --workspace"
alias cbin="cargo binstall"
alias cia="cargo insta approve"
alias cir="cargo insta reject"
alias civ="cargo insta review"
